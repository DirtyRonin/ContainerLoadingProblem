...
const initialState: CargoState = {
  ...
  export const FetchAllCargo = createAsyncThunk(
    "cargos/fetchAllStatus",
    async () => {
  ...
  export const DeleteCargo = createAsyncThunk(
    "cargos/RemoveStatus",
    async (id: number, thunkAPI) => await CargoApi.DeleteCargo(id)
  );
  
  export const UpdateCargo = createAsyncThunk(
    "cargos/UpdateStatus",
    async (cargo: ICargo, thunkAPI) => await CargoApi.UpdateCargo(cargo)
  );
  
  export const CreateCargo = createAsyncThunk(
    "cargos/CreateStatus",
    async (cargo: ICargo, thunkAPI) => await CargoApi.CreateCargo(cargo)
  );
